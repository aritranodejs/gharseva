  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Worker Support</Text>
        <View style={{ width: 44 }} />
      </View>

      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.contactSection}>
          <Text style={styles.subTitle}>PARTNER SUPPORT</Text>
        ...
        <View style={styles.faqSection}>
          ...
          {faqs.length > 0 ? (
            ...
            <View style={styles.faqWrapper}>
               <Text style={[styles.faqText, { color: '#9CA3AF' }]}>1. How do I get more jobs?</Text>
               <Text style={[styles.answerText, { marginTop: 8 }]}>Stay online in busy areas and maintain a high rating to receive more requests.</Text>
               
               <Text style={[styles.faqText, { color: '#9CA3AF', marginTop: 20 }]}>2. When will I get paid?</Text>
               <Text style={[styles.answerText, { marginTop: 8 }]}>Earnings are usually settled weekly to your registered bank account.</Text>
            </View>
          )}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  faqSection: {},
  faqWrapper: { borderBottomWidth: 1, borderBottomColor: '#F9FAFB', paddingVertical: 10 },
